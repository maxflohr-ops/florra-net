...
const metadata={
 ...
 management:['artist management — ridgeclub, ebril & mckayla | florra','Florra manages Ridgeclub, Ebril and McKayla Maroney across music, livestreams, publishing and brand partnerships. Explore the roster and get in touch.'],
 ...
 cucumbers:['cucumbers — florra’s small-batch pickle project','Meet Florra’s homegrown cucumber and small-batch pickle project. The brand is in development; join the list for news about the first jars.'],
 ...
 bandersnatch:['bandersnatch — lore & fashion brand | florra','Discover Bandersnatch, Florra’s first brand built around lore and fashion. Explore the fictional estate, clothing, artwork and stories at bandersnatch.world.'],
...
for(const file of ['editorial.css','scroll-score.css','editorial.js','soundtrack.js','california-hills.jpg','rose-botanical.png','rose-petal.png','rose.js','scroll-motion.js','enchanted-rose.js']) await copyFile('assets/'+file,'public/assets/'+file);
await mkdir('public/assets/audio',{recursive:true});
await copyFile('assets/audio/biting-bullets.m4a','public/assets/audio/biting-bullets.m4a');
await mkdir('public/assets/vendor',{recursive:true});
for(const file of ['three.min.js','three-LICENSE.txt']) await copyFile('assets/vendor/'+file,'public/assets/vendor/'+file);
