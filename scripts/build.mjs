...
for(const file of ['editorial.css','editorial.js','california-hills.jpg','rose-botanical.png','rose-petal.png','rose.js']) await copyFile('assets/'+file,'public/assets/'+file);
