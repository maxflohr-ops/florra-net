...
for(const file of ['editorial.css','editorial.js','soundtrack.js','california-hills.jpg','rose-botanical.png','rose-petal.png','rose.js','scroll-motion.js','enchanted-rose.js']) await copyFile('assets/'+file,'public/assets/'+file);
