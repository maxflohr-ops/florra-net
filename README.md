...
Submit https://www.florra.net/sitemap.xml in the verified Google Search Console property and inspect the homepage and key service URLs. Search Console access is required to confirm indexing, selected canonicals, queries, impressions and Core Web Vitals. These changes do not guarantee ranking or indexing. Separate brand websites are outside this change.
