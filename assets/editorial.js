...
if(dialog){
 ...
 const observer=new MutationObserver(()=>{
  ...
  if(!opened&&document.activeElement&&dialog.contains(document.activeElement)) document.querySelector(document.body.dataset.plucking?'.rose-target':'a[href="#worlds"]')?.focus({preventScroll:true});
 });
